...
export default function Header() {
  ...
  const navLinks = [
    { to: '/0/how-it-works', label: t.nav.howItWorks },
    { to: '/0/symptoms', label: t.nav.symptoms },
    { to: '/0/treatments', label: t.nav.treatments },
    { to: '/0/pricing', label: t.nav.pricing },
    { to: '/0/employers', label: t.nav.employers },
    { to: '/0/blog', label: t.nav.blog },
  ];
    ...
    <header className="sticky top-0 z-50 bg-cream/95 backdrop-blur-sm border-b border-sage/20">
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          {/* Logo */}
          <Link to="/0" className="font-serif text-2xl lg:text-3xl font-bold text-forest tracking-tight no-underline">
            Equivie
          </Link>
